(() => {
  if (!document.querySelector('link[href="order-trace-journey.css"]')) {
    const journeyStyles = document.createElement('link');
    journeyStyles.rel = 'stylesheet';
    journeyStyles.href = 'order-trace-journey.css';
    ...
    <div class="journey-workspace" aria-label="Interactive Order Trace journey">
      ...
      <div class="journey-rail-wrap" aria-label="Order-to-Cash lifecycle checkpoints">
        <div class="journey-rail" role="group" aria-label="Select a lifecycle decision point">
          ...
          <button class="stage-button journey-step stage-1" data-stage="commitment" aria-pressed="false"><span class="journey-step-index">01</span><span class="journey-step-node"><span>01</span></span><span class="journey-step-label">Customer commitment</span><span class="journey-step-summary">Define the promise and its evidence.</span></button>
          <button class="stage-button journey-step stage-2" data-stage="validation" aria-pressed="true"><span class="journey-step-index">02</span><span class="journey-step-node"><span>02</span></span><span class="journey-step-label">Validation</span><span class="journey-step-summary">Confirm data, terms, policy, and quality.</span></button>
          <button class="stage-button journey-step stage-3" data-stage="availability" aria-pressed="false"><span class="journey-step-index">03</span><span class="journey-step-node"><span>03</span></span><span class="journey-step-label">Availability + fulfillment</span><span class="journey-step-summary">Match supply and priority to the promise.</span></button>
          <button class="stage-button journey-step stage-4" data-stage="delivery" aria-pressed="false"><span class="journey-step-index">04</span><span class="journey-step-node"><span>04</span></span><span class="journey-step-label">Delivery</span><span class="journey-step-summary">Make handoff, proof, and recovery visible.</span></button>
          <button class="stage-button journey-step stage-5" data-stage="invoice" aria-pressed="false"><span class="journey-step-index">05</span><span class="journey-step-node"><span>05</span></span><span class="journey-step-label">Invoice</span><span class="journey-step-summary">Create an accurate financial claim.</span></button>
          <button class="stage-button journey-step stage-6" data-stage="payment" aria-pressed="false"><span class="journey-step-index">06</span><span class="journey-step-node"><span>06</span></span><span class="journey-step-label">Payment</span><span class="journey-step-summary">Resolve barriers with explicit authority.</span></button>
          <button class="stage-button journey-step stage-7" data-stage="learning" aria-pressed="false"><span class="journey-step-index">07</span><span class="journey-step-node"><span>07</span></span><span class="journey-step-label">Learning</span><span class="journey-step-summary">Classify recurrence and adoption burden.</span></button>
          <button class="stage-button journey-step stage-8" data-stage="reuse" aria-pressed="false"><span class="journey-step-index">08</span><span class="journey-step-node"><span>08</span></span><span class="journey-step-label">Reusable improvement</span><span class="journey-step-summary">Scale only what transfers with value.</span></button>
        </div>
      </div>
      ...
      <div class="journey-decision" aria-live="polite">
        ...
        <div class="journey-decision-grid">
          <div class="journey-decision-cell journey-primary"><span>02 · Selected checkpoint</span><h2 data-stage-title>Validation</h2><p data-stage-copy>Are the order, terms, pricing, data, and regulatory conditions complete enough to proceed?</p><div class="lens" data-stage-lens><span>Customer</span><span>Data</span><span>Policy</span><span>Quality</span></div></div>
  ...
  if (!document.querySelector('script[src="order-trace-journey.js"]')) {
    const journeyScript = document.createElement('script');
    journeyScript.src = 'order-trace-journey.js';
